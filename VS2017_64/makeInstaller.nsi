...
OutFile "ApertusVR_SDK_VS2017_64.exe"
...
Section
    ...
    #3rdParties begin
		...
		#nodejs
		SetOutPath $INSTDIR\3rdParty\nodejs\8.0.0\source\src
		File "$%APERTUSVR_SOURCE%\3rdParty\nodejs\8.0.0\source\src\" 
		SetOutPath $INSTDIR\3rdParty\nodejs\8.0.0\source\deps\uv\include
		File "$%APERTUSVR_SOURCE%\3rdParty\nodejs\8.0.0\source\deps\uv\include\" 
		SetOutPath $INSTDIR\3rdParty\nodejs\8.0.0\source\deps\v8\include
		File "$%APERTUSVR_SOURCE%\3rdParty\nodejs\8.0.0\source\deps\v8\include\" 
		SetOutPath $INSTDIR\3rdParty\nodejs\8.0.0\source\Debug
		File "$%APERTUSVR_SOURCE%\3rdParty\nodejs\8.0.0\source\Debug\node.lib" 
		SetOutPath $INSTDIR\3rdParty\nodejs\8.0.0\source\Release
		File "$%APERTUSVR_SOURCE%\3rdParty\nodejs\8.0.0\source\Release\node.lib"
